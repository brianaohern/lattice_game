...
#include "LatticeWeapon.generated.h"

// class UAnimMontage;
class ALatticeGameCharacter;
...
class ALatticeWeapon : public AActor
{
...
// 	}
	...
	virtual void OnEquip(const ALatticeWeapon* LastWeapon);
	...
	virtual void OnEnterInventory(ALatticeGameCharacter* NewOwner);
...
// 	class ALatticeGameCharacter* GetPawnOwner() const;
...
// 	bool bHideCrosshairWhileNotAiming;
	...
	void SetOwningPawn(ALatticeGameCharacter* ALatticeGameCharacter);
...
protected:
	...
	class ALatticeGameCharacter* MyPawn;
...
// 	virtual void StopSimulatingWeaponFire();
	...
	virtual void FireWeapon() PURE_VIRTUAL(ALatticeWeapon::FireWeapon,);
